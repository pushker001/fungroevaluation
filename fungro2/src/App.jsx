    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <main className="container mx-auto mt-10 px-6">
        <div className="flex flex-col-reverse md:flex-row items-center">
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold">TEENLANCERS</h1>
            <p className="mt-4 text-lg md:text-xl">Real companies, real projects, real earnings and real money</p>
            <p className="mt-2 text-base md:text-lg">Smart opportunities for the smart generation</p>
            <div className="flex mt-6 space-x-4 justify-center md:justify-start">
              ...
              <a href="#" className="bg-green-500 hover:bg-green-400 py-2 px-4 rounded">
                <FaApple size={32} className="text-gray-800" alt="App Store" />
              </a>
            </div>
          </div>
      ...
      <div className='flex justify-around gap-3 mt-10'>
       ...
       <div className='mt-[4rem]'>
        ...
        <div className='mt-[3rem] bg-gray-800 w-full flex flex-wrap justify-around gap-4 pt-20'>
